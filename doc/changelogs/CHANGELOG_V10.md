...
* Embedder support:
  - Functions for creating V8 `Isolate` and `Context` objects with Node.js-specific behaviour have been added to the API. (helloshuangzi) [#20639](https://github.com/nodejs/node/pull/20639)
...
* [[`104c3bc443`](https://github.com/nodejs/node/commit/104c3bc443)] - **esm**: provide named exports for builtin libs (Gus Caplan) [#20403](https://github.com/nodejs/node/pull/20403)
