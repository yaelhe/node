...
<a id="8.11.2"></a>
## 2018-05-18, Version 8.11.2 'Carbon' (LTS), @MylesBorins
...
* [[`55cf145ed6`](https://github.com/nodejs/node/commit/55cf145ed6)] - **deps,src**: align ssize\_t ABI between Node & nghttp2 (Anna Henningsen) [#18565](https://github.com/nodejs/node/pull/18565)
* [[`4dc0b3cda1`](https://github.com/nodejs/node/commit/4dc0b3cda1)] - **doc**: add Http2Session.connecting property (Pieter Mees) [#19842](https://github.com/nodejs/node/pull/19842)
* [[`22eddf1599`](https://github.com/nodejs/node/commit/22eddf1599)] - **doc**: guard against md list parsing edge case (Vse Mozhet Byt) [#19647](https://github.com/nodejs/node/pull/19647)
* [[`8f559714d8`](https://github.com/nodejs/node/commit/8f559714d8)] - **doc**: rename HTTP2 to HTTP/2 (Timothy Gu) [#19603](https://github.com/nodejs/node/pull/19603)
* [[`8daddfb11d`](https://github.com/nodejs/node/commit/8daddfb11d)] - **doc**: add note about browsers and HTTP/2 (Steven) [#19476](https://github.com/nodejs/node/pull/19476)
* [[`d85e5f4d46`](https://github.com/nodejs/node/commit/d85e5f4d46)] - **doc**: fix typo in http2.md (Vse Mozhet Byt) [#18872](https://github.com/nodejs/node/pull/18872)
* [[`8b234f5a28`](https://github.com/nodejs/node/commit/8b234f5a28)] - **doc**: warn against concurrent http2stream.respondWithFD (Anna Henningsen) [#18762](https://github.com/nodejs/node/pull/18762)
...
* [[`3a890a88ec`](https://github.com/nodejs/node/commit/3a890a88ec)] - **doc, http2**: add sections for server.close() (Chris Miller) [#19802](https://github.com/nodejs/node/pull/19802)
...
* [[`5ea29ef917`](https://github.com/nodejs/node/commit/5ea29ef917)] - **(SEMVER-MINOR)** **http**: add options to http.createServer() (Peter Marton) [#15752](https://github.com/nodejs/node/pull/15752)
...
* [[`c83098ad89`](https://github.com/nodejs/node/commit/c83098ad89)] - **http2**: emit session connect on next tick (Pieter Mees) [#19842](https://github.com/nodejs/node/pull/19842)
* [[`af7c7cbd9f`](https://github.com/nodejs/node/commit/af7c7cbd9f)] - **http2**: callback valid check before closing request (Trivikram) [#19061](https://github.com/nodejs/node/pull/19061)
* [[`519b063be1`](https://github.com/nodejs/node/commit/519b063be1)] - **http2**: destroy() stream, upon errnoException (Sarat Addepalli) [#19389](https://github.com/nodejs/node/pull/19389)
* [[`0137eb726b`](https://github.com/nodejs/node/commit/0137eb726b)] - **http2**: remove some unnecessary next ticks (James M Snell) [#19451](https://github.com/nodejs/node/pull/19451)
* [[`f165e9f328`](https://github.com/nodejs/node/commit/f165e9f328)] - **http2**: no stream destroy while its data is on the wire (Anna Henningsen) [#19002](https://github.com/nodejs/node/pull/19002)
* [[`10aaa74cc7`](https://github.com/nodejs/node/commit/10aaa74cc7)] - **http2**: fix flaky test-http2-https-fallback (Matteo Collina) [#19093](https://github.com/nodejs/node/pull/19093)
* [[`1f3ab4f8de`](https://github.com/nodejs/node/commit/1f3ab4f8de)] - **http2**: fix endless loop when writing empty string (Anna Henningsen) [#18924](https://github.com/nodejs/node/pull/18924)
* [[`03793507be`](https://github.com/nodejs/node/commit/03793507be)] - **http2**: use original error for cancelling pending streams (Anna Henningsen) [#18988](https://github.com/nodejs/node/pull/18988)
* [[`102936969c`](https://github.com/nodejs/node/commit/102936969c)] - **http2**: send error text in case of ALPN mismatch (Anna Henningsen) [#18986](https://github.com/nodejs/node/pull/18986)
* [[`b1d95ecbf2`](https://github.com/nodejs/node/commit/b1d95ecbf2)] - **http2**: fix condition where data is lost (Matteo Collina) [#18895](https://github.com/nodejs/node/pull/18895)
* [[`28a27297c1`](https://github.com/nodejs/node/commit/28a27297c1)] - **http2**: use `\_final` instead of `on('finish')` (Anna Henningsen) [#18609](https://github.com/nodejs/node/pull/18609)
* [[`ae2ebdeb4c`](https://github.com/nodejs/node/commit/ae2ebdeb4c)] - **http2**: add req and res options to server creation (Peter Marton) [#15560](https://github.com/nodejs/node/pull/15560)
* [[`58478d8307`](https://github.com/nodejs/node/commit/58478d8307)] - **(SEMVER-MINOR)** **http2**: add http fallback options to .createServer (Peter Marton) [#15752](https://github.com/nodejs/node/pull/15752)
...
* [[`367113f5d7`](https://github.com/nodejs/node/commit/367113f5d7)] - **(SEMVER-MINOR)** **n-api**: bump version of n-api supported (Michael Dawson) [#19497](https://github.com/nodejs/node/pull/19497)
...
* [[`3a6b7e610d`](https://github.com/nodejs/node/commit/3a6b7e610d)] - **(SEMVER-MINOR)** **n-api**: add napi\_fatal\_exception (Mathias Buus) [#19337](https://github.com/nodejs/node/pull/19337)
...
* [[`927fc0b19f`](https://github.com/nodejs/node/commit/927fc0b19f)] - **(SEMVER-MINOR)** **n-api**: add methods to open/close callback scope (Michael Dawson) [#18089](https://github.com/nodejs/node/pull/18089)
...
* [[`853b4d593c`](https://github.com/nodejs/node/commit/853b4d593c)] - **(SEMVER-MINOR)** **n-api**: expose n-api version in process.versions (Michael Dawson) [#18067](https://github.com/nodejs/node/pull/18067)
...
* [[`6bdfb1f8f0`](https://github.com/nodejs/node/commit/6bdfb1f8f0)] - **(SEMVER-MINOR)** **perf_hooks,http2**: add performance.clear() (James M Snell) [#18046](https://github.com/nodejs/node/pull/18046)
...
* [[`c6a9abd96b`](https://github.com/nodejs/node/commit/c6a9abd96b)] - **src**: add nullptr check for session in DEBUG macro (Daniel Bevenius) [#18815](https://github.com/nodejs/node/pull/18815)
...
* [[`f5a2cd5017`](https://github.com/nodejs/node/commit/f5a2cd5017)] - **test**: http2 errors on req.close() (Trivikram) [#18854](https://github.com/nodejs/node/pull/18854)
* [[`9c7bf7f9cf`](https://github.com/nodejs/node/commit/9c7bf7f9cf)] - **test**: http2 stream.respond() error checks (Trivikram) [#18861](https://github.com/nodejs/node/pull/18861)
* [[`199d9a5c5a`](https://github.com/nodejs/node/commit/199d9a5c5a)] - **test**: check endless loop while writing empty string (XadillaX) [#18924](https://github.com/nodejs/node/pull/18924)
...
* [[`e15f57745d`](https://github.com/nodejs/node/commit/e15f57745d)] - **(SEMVER-MINOR)** **timers**: allow Immediates to be unrefed (Anatoli Papirovski) [#18139](https://github.com/nodejs/node/pull/18139)
